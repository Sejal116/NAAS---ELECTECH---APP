...
import { CheckIcon, StarIcon, PhoneIcon, EnvelopeIcon, ChatBubbleBottomCenterTextIcon } from 'react-native-heroicons/solid';
import { themeColors } from '../theme';
import { Home, ShoppingBag } from 'react-native-feather';
    ...
    <View className="flex-1">
      ...
      <SafeAreaView className="space-y-4 flex-1">
        ...
        <View className="px-4 space-y-2">
          <Text style={{color: themeColors.text}} className="text-lg font-bold">Contact</Text>
          <View className="flex-row justify-between">
            <TouchableOpacity 
             onPress={()=> setSize('small')}
             style={{backgroundColor: size=='0-150'? themeColors.bgLight: 'rgba(0,0,0,0.07)'}} 
            ...
            <TouchableOpacity 
             onPress={()=> setSize('150-500')}
             style={{backgroundColor: size=='150-500'? themeColors.bgLight: 'rgba(0,0,0,0.07)'}}
              className="p-3 px-8 rounded-full">
              <EnvelopeIcon size="24" color="black" />
            </TouchableOpacity>
            <TouchableOpacity 
             onPress={()=> setSize('500+')}
             style={{backgroundColor: size=='500+'? themeColors.bgLight: 'rgba(0,0,0,0.07)'}} 
             className="p-3 px-8 rounded-full">
              <ChatBubbleBottomCenterTextIcon size="24" color="black" />
            </TouchableOpacity>
          </View>
        </View>
      ...
      <View className={`space-y-3 ${ios? 'mb-6': 'mb-3'}`}>
          <View className="flex-row justify-between items-center px-4 mb-2">
              <View className="flex-row items-center space-x-1">
                ...
                <Text className="text-base text-black font-semibold"> </Text>
              </View>
              <View 
                ...
                <Text style={{color: themeColors.text}} className="font-extrabold text-lg">150</Text>
                <TouchableOpacity>
          ...
          <View className="flex-row justify-between px-4">
            ...
            <TouchableOpacity 
              ...
              <Text className="text-center text-white text-base font-semibold">Contact Now</Text>
            </TouchableOpacity>
          </View>
        </View>
